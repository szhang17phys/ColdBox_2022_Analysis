...
//        h->Fill(j*dtime,raw[j]);
    ...
    if(maxADC>6580){
        peak1 += 1;
	cout<<"Label of type4(peak3): "<<waveNum<<endl;
    }
...
//	break;
  ...
  cout<<"========================================="<<endl;
  cout<<"Integral of Others: "<<peak0<<endl;
  cout<<"Integral of dual-peak signal: "<<peak1<<endl;
