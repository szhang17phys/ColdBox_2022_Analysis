...
void select_single_waveform_ch4(){
  ...
  ifstream fin;
  fin.open("/afs/cern.ch/user/s/shuaixia/private/PDS_Data/cathodexarapuca/wave4.dat", ios::in | ios::binary);
  ...
  while(!fin.fail()){ 
    ...
    if(first_line){
      ...
      first_line=false;
      h1 = new TH2D("h1","h1",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h2 = new TH2D("h2","h2",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h3 = new TH2D("h3","h3",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h4 = new TH2D("h4","h4",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h5 = new TH2D("h5","h5",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h6 = new TH2D("h6","h6",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h7 = new TH2D("h7","h7",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h8 = new TH2D("h8","h8",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h9 = new TH2D("h9","h9",memorydepth,0,memorydepth*dtime,nADCs,6500,6800);
      h10 = new TH2D("h10","h10",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
      h11 = new TH2D("h11","h11",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
      h12 = new TH2D("h12","h12",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
      h13 = new TH2D("h13","h13",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
      h14 = new TH2D("h14","h14",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
      h15 = new TH2D("h15","h15",memorydepth,0,memorydepth*dtime,nADCs,6400,6800);
