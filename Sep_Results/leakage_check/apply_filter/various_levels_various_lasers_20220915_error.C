...
void various_levels_various_lasers_20220915_error(){
...
//======General Variables====================  
  ...
  double baseline_value = 3350;
  level[0] = baseline_value + 50;//for wave5.dat---
...
//======Read Laser 1========================
  ...
  cout<<"check: Read sucessfully!======================="<<endl;
