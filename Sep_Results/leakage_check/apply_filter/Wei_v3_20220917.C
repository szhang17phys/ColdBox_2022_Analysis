...
//======Read v3 laser 1 (20220917; low power)===========
  fin.open("/afs/cern.ch/work/s/shiw/public/ColdBoxVD/Coldbox_Sep2022_leakage_check/20220917_v3_laser1_388_laser2_410_laser3_250/cathode_v3_laser_1_and_argon_read/wave5.dat", ios::in | ios::binary);
  ...
  cout<<"=====Result of v3 laser 1 (low power):======== "<<endl;
  for(int i=0; i<8; ++i){
...
//======Read v2 laser 2 (low power)========================
  fin.open("/afs/cern.ch/work/s/shiw/public/ColdBoxVD/Coldbox_Sep2022_leakage_check/20220917_v3_laser1_388_laser2_410_laser3_250/cathode_v3_laser_2_and_argon_read/wave5.dat", ios::in | ios::binary);
  ...
  cout<<"=====Result of v3 laser 2 (low power):======== "<<endl;
  for(int i=0; i<8; ++i){
...
//======Read v3 laser 3 (low power)========================
  fin.open("/afs/cern.ch/work/s/shiw/public/ColdBoxVD/Coldbox_Sep2022_leakage_check/20220917_v3_laser1_388_laser2_410_laser3_250/cathode_v3_laser_3_and_argon_read/wave5.dat", ios::in | ios::binary);
  ...
  cout<<"=====Result of v3 laser 3 (low power):======== "<<endl;
  for(int i=0; i<8; ++i){
...
//======Read all lasers of v3========================
  fin.open("/afs/cern.ch/work/s/shiw/public/ColdBoxVD/Coldbox_Sep2022_leakage_check/20220917_v3_laser1_388_laser2_410_laser3_250/cathode_v3_laser_123_and_argon_read/wave5.dat", ios::in | ios::binary);
  ...
  cout<<"====Result of All lasers of v3 (low power):=== "<<endl;
  for(int i=0; i<8; ++i){
