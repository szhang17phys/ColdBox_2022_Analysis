...
void select_single_waveform(){
  ...
  while(!fin.fail()){ 
    ...
    if(first_line){
      ...
      first_line=false;
      h1 = new TH2D("h1","h1",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h2 = new TH2D("h2","h2",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h3 = new TH2D("h3","h3",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h4 = new TH2D("h4","h4",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h5 = new TH2D("h5","h5",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h6 = new TH2D("h6","h6",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h7 = new TH2D("h7","h7",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h8 = new TH2D("h8","h8",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h9 = new TH2D("h9","h9",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
      h10 = new TH2D("h10","h10",memorydepth,0,memorydepth*dtime,nADCs,6450,6700);
