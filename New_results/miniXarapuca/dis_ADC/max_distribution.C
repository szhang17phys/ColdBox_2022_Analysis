...
void max_distribution(){
  ...
  TH1F *dis = new TH1F("dis", "Distribution of max ADC",100,6000,7000);
  int maxADC = 0;
  int raw_mid = 0;  

  ifstream fin;
  fin.open("/mnt/d/PDS_data_temp/minixarapuca-wall-copper/wave6.dat", ios::in | ios::binary);
